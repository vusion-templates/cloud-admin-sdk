...
const add_3 = __importDefault(require("../plop/module/add"));
const remove_2 = __importDefault(require("../plop/module/remove"));
module.exports = function (plop) {
    ...
    plop.setGenerator('add-module', add_3.default(plop));
    plop.setGenerator('remove-module', remove_2.default(plop));
};
